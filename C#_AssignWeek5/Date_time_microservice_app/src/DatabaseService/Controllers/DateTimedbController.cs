...
using DatabaseService.DataContext;

namespace DatabaseService.Controllers
{
    public class DateTimedbController : Controller
    {
        ...
        {
            return View(db.datetimedetails.ToList());
        }

        // GET: datetimerecords/Details/5
